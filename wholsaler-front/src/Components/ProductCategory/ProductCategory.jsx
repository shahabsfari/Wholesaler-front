...
export default function ProductCategory({ url, text }) {
  return (
    <div className='relative  text-white flex justify-center items-center font-DanaDemiBold text-base sm:text-xl w-full h-[75px] sm:h-[100px] cursor-pointer rounded-xl ' >
