...
export default function ProductBox({ productData:{ title , number , discountPer , oldPrice, originalPrice , url , productKey } }) {
    return (
                ...
                <div className='flex justify-between mt-3 ' >
                    ...
                    <div className='flex flex-col'>
                        <span className='relative text-zinc-500 w-fit' >
                            ...
                            <span className='text-[10px]' >{oldPrice}</span><span className='text-[8px]'>تومان</span>
                        </span>
                        <span className='flex gap-x-1'>
                            <span className='font-DanaDemiBold text-[12px] md:text-[16px] '>{originalPrice}</span><span className='text-[10px] md:text-sm translate-y-[1px]' >تومان</span>
                        </span>
                    </div>
                </div>
            </div>
